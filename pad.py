...
tokens = list([int(i) for i in tokens])
...
def train_merges(ids):
    ...
    print(f'compression: {round(len(tokens) / len(ids), 2)}')
    return my_merges
...
merges = train_merges(ids=list(tokens))
...
print(regex.findall(gpt2pat, "Hello123        you's world!"))
